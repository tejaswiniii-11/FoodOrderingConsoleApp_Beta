...
import com.aurionpro.invoice.InvoiceViewer;
...
public class Admin implements ICheckUser {
    ...
    public void showAdminInterface() {
        ...
        do {
            ...
            System.out.println("9. View Customer Invoices");
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    System.out.print("Enter course type (Starters / Main Course / Desserts): ");
                    String courseType = scanner.nextLine();

                    menuManager.addMenuItem(menuName, itemName, price, courseType);
                    break;
                ...
                case 9:
                    // ✅ View stored invoice files
                    InvoiceViewer.displayAllInvoices();
                    break;
